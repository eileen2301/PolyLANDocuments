...
When you have connected to the server change to the map that won the veto by typing {\fontfamily{pcr}\selectfont 
...
\subsection{Pause}
\label{sec:pause}
Do not hesitate to use the pause function if you are experiencing any kind of problem or want to take a tactical timeout. Write {\fontfamily{pcr}\selectfont !pause} into the ingame chat at any time to pause the match after the next freezetime. Use {\fontfamily{pcr}\selectfont 
